...
| gw9zj | 主工作区运行态同步到新 Worktree 的自动 Bootstrap | 已完成 | `gw9zj-worktree-runtime-bootstrap/SPEC.md` | 2026-03-31 | `.env.local` 与 SQLite ledger 自动补齐，并对齐新的 registry.sqlite 默认文件名 |
...
| rxae7 | 默认 SQLite 数据库文件名规范化 | 已完成 | `rxae7-registry-db-filename/SPEC.md` | 2026-03-31 | 默认库名收敛为 registry.sqlite，并兼容历史 signup-tasks.sqlite |
