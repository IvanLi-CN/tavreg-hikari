...
| zxuvb | Microsoft proof 补邮箱分支修复与多语言诊断加固 | 部分完成（3/4） | `zxuvb-microsoft-proof-surface-locale-hardening/SPEC.md` | 2026-04-17 | 本地 typecheck / bun test / review 收口已完成，待 101 上线回归 |
