...
| 55uxa | 默认邮箱生成收敛：provider-first + 真人风格兜底 | 已实现 | `55uxa-provider-first-default-mailboxes/SPEC.md` | 2026-04-12 | ChatGPT draft provider-first、DuckMail 共用真人风格 local-part，移除 `CHATGPT_CFMAIL_ROOT_DOMAIN` 依赖，待评审 |
