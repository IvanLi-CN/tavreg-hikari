...
| 9h2xd | 收敛 macOS 下 headless Chrome 启动卡住问题 | 已完成 | `9h2xd-macos-headless-chrome-launch/SPEC.md` | 2026-03-27 | macOS Chrome 统一回退到 Playwright 直启，避免 native CDP 连接超时拖住 worker |
