      ...
      <div className="min-w-0 space-y-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>支持批量目标、并发与尝试预算；每个 attempt 都会在启动时自动生成独立的 cf-mail 邮箱、密码、昵称与生日资料。</CardDescription>
          </CardHeader>
          ...
          <CardHeader>
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <CardDescription>批量模式下会并发拉起多个 headed attempt；每个 attempt 使用独立自动生成资料，缺少 refresh token 仍直接判失败。</CardDescription>
              </div>
