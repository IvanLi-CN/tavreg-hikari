...
export const sampleProxies: ProxyPayload = {
  settings: {
    ...
    checkUrl: "https://connectivity.example.test/generate_204",
    timeoutMs: 1000,
    maxLatencyMs: 480,
    apiPort: 9090,
    mixedPort: 7890,
            ...
            ip_metadata: [
              {
                ...
                probe_updated_at: new Date(Date.now() - 5 * 60 * 1000).toISOString(),
                country_name: "Japan",
                region_name: "Tokyo",
                city: "Tokyo",
              },
            ...
            ip_metadata: [
              {
                ip: "198.51.100.18",
                last_probe_ok: false,
                last_latency_ms: 1640,
                median_latency_ms: 1510,
                probe_updated_at: new Date(Date.now() - 6 * 60 * 1000).toISOString(),
